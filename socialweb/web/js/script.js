if(window.location.pathname.match("/socialweb/web/app_dev.php/rejestracja")){
...
if(window.location.pathname.match("/socialweb/web/app_dev.php/login")){
...
$('#title-reg').click(function(event){
	
	if(!window.location.pathname.includes("/socialweb/web/app_dev.php/rejestracja"))
		window.location.pathname = "/socialweb/web/app_dev.php/rejestracja";
});
	
$('#title-log').click(function(event){
	
	if(!window.location.pathname.includes("/socialweb/web/app_dev.php/login"))
		window.location.pathname = "/socialweb/web/app_dev.php/login";
});
