...
class CommentsController extends Controller{
	...
	public function add_image_commmentAction(CookieService $cookie_service,DBService $db_service,Request $request,$image_id){
		...
		if($request->isXmlHttpRequest() == "true"){
			...
			$image_comment_input = $request->get('image_comment_input');
			...
			if($image_comment_input == '')
				...
				$db_service->add_image_commment($type,$image_comment_input,$image_id,$comment_id);
